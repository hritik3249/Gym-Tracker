    ...
    <Card className="p-4">
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        <div>
          ...
          <Input type="number" min={0} max={60} inputMode="numeric" value={minutes} onChange={(e) => updateMinutes(e.target.value)} />
        </div>
        <div>
          <label className="mb-1 block text-xs font-bold uppercase tracking-[0.14em] text-steel">Sec</label>
          <Input type="number" min={0} max={59} inputMode="numeric" value={seconds} onChange={(e) => updateSeconds(e.target.value)} />
        </div>
      </div>
